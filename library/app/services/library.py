...
class Library:
    ...
    def __init__(self):
        ...
        Safe.run(self._load_users)
        Safe.run(self._load_books)
        Safe.run(self._ensure_admin_exists)
    ...
    def _load_users(self):
        ...
        try:
            ...
            raise ValidationError("users.json დაზიანებულია")
    ...
    def _load_books(self):
        ...
        try:
            ...
            raise ValidationError("books.json დაზიანებულია")
    ...
    def find_books_by_title(self, title):
        title = title.lower()
        return [b for b in self.books if b.title.lower() == title]

    def find_books_by_author(self, author):
        author = author.lower()
        return [b for b in self.books if b.author.lower() == author]
